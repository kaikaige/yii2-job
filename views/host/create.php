...
<div class="user-admin-form">
    ...
    <?php } ?>
    <?= $form->field($model, 'alias')->textInput(['maxlength' => true, 'placeholder' => '节点名称']) ?>
    <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => '主机地址']) ?>
    <?= $form->field($model, 'port')->textInput(['maxlength' => true, 'placeholder' => '端口']) ?>
